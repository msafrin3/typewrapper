...
<template>
    <Head title="Tambah Baru Mukim" />

    <AuthenticatedLayout>
        <ContentHeader title="Tambah Baru Mukim" :breadcrumbs="breadcrumbs" />

        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mb-0">Tambah Baru Mukim</h3>
                    </div>
                    <form @submit.prevent="submit">
                        <div class="card-body">
                            <div class="form-group mb-3">
                                <label>Negeri <span class="text-danger">*</span></label>
                                <select class="form-control" v-model="parish.state_id" @change="filter.state_id = parish.state_id;doFilter()">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" v-model="parish.district_id">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukkan nama mukim" v-model="parish.name">
