...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    let submit = () => {
      router.post(route("admin.meta.store"), meta, {
        onSuccess: (response) => {
                      ...
                      createVNode("div", { class: "card-body" }, [
                        createVNode("div", { class: "form-group mb-3" }, [
                          ...
                          withDirectives(createVNode("input", {
                            ...
                            "onUpdate:modelValue": ($event) => unref(meta).name = $event
                          }, null, 8, ["onUpdate:modelValue"]), [
                            [vModelText, unref(meta).name]
                          ]),
                        ...
                        createVNode("div", { class: "form-group" }, [
                          ...
                          withDirectives(createVNode("input", {
                            ...
                            "onUpdate:modelValue": ($event) => unref(meta).display_name = $event
                          }, null, 8, ["onUpdate:modelValue"]), [
                            [vModelText, unref(meta).display_name]
                          ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Meta/Create.vue");
