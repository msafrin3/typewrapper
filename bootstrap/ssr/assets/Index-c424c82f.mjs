      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (_ctx.$page.props.auth.user.can.includes("create-bencana")) {
            ...
            _push2(`<div class="card"${_scopeId}><div class="card-header"${_scopeId}><h3 class="card-title mb-0"${_scopeId}>Senarai Bencana</h3></div><div class="card-body"${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(__props.disasters.data, (disaster, index) => {
                    ...
                    if (_ctx.$page.props.auth.user.can.includes("delete-bencana")) {
                        ...
                        return openBlock(), createBlock("tr", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("div", { class: "d-flex gap-2" }, [
                              ...
                              _ctx.$page.props.auth.user.can.includes("delete-bencana") ? (openBlock(), createBlock("button", {
                                key: 0,
                                type: "button",
            ...
            return [
              ...
              _ctx.$page.props.auth.user.can.includes("create-bencana") ? (openBlock(), createBlock("div", {
                key: 0,
                class: "mb-3"
              }, [
                createVNode(unref(Link), {
