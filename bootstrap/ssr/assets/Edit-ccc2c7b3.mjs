import { reactive, onMounted, unref, withCtx, openBlock, createBlock, Fragment, renderList, toDisplayString, createTextVNode, createVNode, withModifiers, withDirectives, vModelText, createCommentVNode, useSSRContext } from "vue";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
                  ssrRenderList(__props._permissions, (permission) => {
                    _push3(`<option${ssrRenderAttr("value", permission.id)}${ssrIncludeBooleanAttr(unref(e_role).permissions.includes(permission.id)) ? " selected" : ""}${_scopeId2}>${ssrInterpolate(permission.name)}</option>`);
                  });
                  _push3(`<!--]-->`);
                } else {
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props._permissions, (permission) => {
                      return openBlock(), createBlock("option", {
                        key: permission.id,
                        value: permission.id,
                        selected: unref(e_role).permissions.includes(permission.id)
                      ...
                      createVNode("div", { class: "card-body" }, [
                        createVNode("div", { class: "form-group" }, [
                          ...
                          withDirectives(createVNode("input", {
                            ...
                            "onUpdate:modelValue": ($event) => unref(e_role).name = $event
                          }, null, 8, ["onUpdate:modelValue"]), [
                            [vModelText, unref(e_role).name]
                          ]),
