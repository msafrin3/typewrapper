...
import _sfc_main$3 from "./Table-a4b232be.mjs";
import { format } from "date-fns";
import Swal from "sweetalert2";
import "@inertiajs/inertia";
import "./Pagination-7ef789f3.mjs";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(__props.users.data, (user, index) => {
                    _push3(`<tr class="${ssrRenderClass({ "table-danger": user.deleted_at != null })}"${_scopeId2}><td${_scopeId2}>${ssrInterpolate(unref(iterationPaginated)(__props.users, index))}</td><td${_scopeId2}>${ssrInterpolate(user.name)}</td><td${_scopeId2}>${ssrInterpolate(user.email)}</td><td${_scopeId2}><ul${_scopeId2}><!--[-->`);
                    ssrRenderList(user.roles, (role) => {
                      _push3(`<li${_scopeId2}>${ssrInterpolate(role.name)}</li>`);
                    });
                    _push3(`<!--]--></ul></td><td${_scopeId2}><ul${_scopeId2}><!--[-->`);
                    ssrRenderList(user.permissions, (permission) => {
                      _push3(`<li${_scopeId2}>${ssrInterpolate(permission.name)}</li>`);
                    });
                    _push3(`<!--]--></ul></td><td${_scopeId2}>${ssrInterpolate(unref(format)(new Date(user.created_at), "yyyy-MM-dd HH:mm:ss"))}</td><td${_scopeId2}><div class="d-flex flex-wrap gap-2"${_scopeId2}>`);
                          ...
                          createVNode("td", null, [
                            createVNode("ul", null, [
                              (openBlock(true), createBlock(Fragment, null, renderList(user.roles, (role) => {
                                return openBlock(), createBlock("li", null, toDisplayString(role.name), 1);
                              }), 256))
                            ])
                          ]),
                          createVNode("td", null, [
                            createVNode("ul", null, [
                              (openBlock(true), createBlock(Fragment, null, renderList(user.permissions, (permission) => {
                                return openBlock(), createBlock("li", null, toDisplayString(permission.name), 1);
                              }), 256))
                            ])
                          ]),
