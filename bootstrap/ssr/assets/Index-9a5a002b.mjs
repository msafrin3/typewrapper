      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (_ctx.$page.props.auth.user.can.includes("create-pps")) {
            ...
            _push2(`<div class="card"${_scopeId}><div class="card-header"${_scopeId}><h3 class="card-title mb-0"${_scopeId}>Senarai Pusat Pemindahan Berdaftar</h3></div><div class="card-body"${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(__props.shelters.data, (shelter, index) => {
                    ...
                    if (_ctx.$page.props.auth.user.can.includes("edit-pps")) {
                    ...
                    if (_ctx.$page.props.auth.user.can.includes("delete-pps")) {
                      _push3(`<button type="button" class="btn btn-danger btn-sm"${_scopeId2}><i class="ri-delete-bin-fill align-bottom me-1"${_scopeId2}></i> Delete </button>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div></td></tr>`);
                        ...
                        return openBlock(), createBlock("tr", {
                          ...
                          createVNode("td", null, [
                            createVNode("div", { class: "d-flex gap-2" }, [
                              _ctx.$page.props.auth.user.can.includes("edit-pps") ? (openBlock(), createBlock(unref(Link), {
                                key: 0,
                                href: _ctx.route("shelter.edit", shelter),
                                class: "btn btn-info btn-sm"
                              }, {
                              ...
                              _ctx.$page.props.auth.user.can.includes("delete-pps") ? (openBlock(), createBlock("button", {
                                key: 1,
                                type: "button",
            ...
            return [
              ...
              _ctx.$page.props.auth.user.can.includes("create-pps") ? (openBlock(), createBlock("div", {
                key: 0,
                class: "mb-3"
              }, [
