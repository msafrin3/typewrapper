                      ...
                      createVNode("div", { class: "card-body" }, [
                        createVNode("div", { class: "form-group" }, [
                          ...
                          withDirectives(createVNode("input", {
                            ...
                            "onUpdate:modelValue": ($event) => unref(e_permission).name = $event
                          }, null, 8, ["onUpdate:modelValue"]), [
                            [vModelText, unref(e_permission).name]
                          ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Permission/Edit.vue");
