...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        class: ["nav-link menu-link", { "active": _ctx.$page.url.startsWith("/disaster") }],
        href: _ctx.route("disaster.index")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="ri-thunderstorms-fill"${_scopeId}></i> <span${_scopeId}>Bencana</span>`);
          } else {
            return [
              createVNode("i", { class: "ri-thunderstorms-fill" }),
              createTextVNode(),
              createVNode("span", null, "Bencana")
            ];
          }
        }),
        _: 1
      ...
      _push(`</li><li class="nav-item">`);
      _push(ssrRenderComponent(unref(Link), {
        class: ["nav-link menu-link", { "active": _ctx.$page.url.startsWith("/shelter") }],
        href: _ctx.route("shelter.index")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="ri-home-heart-line"${_scopeId}></i> <span${_scopeId}>Pusat Pemindahan</span>`);
          } else {
            return [
              createVNode("i", { class: "ri-home-heart-line" }),
              createTextVNode(),
              createVNode("span", null, "Pusat Pemindahan")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li><li class="nav-item"><a class="nav-link menu-link" href="#menureport" data-bs-toggle="collapse" role="button"${ssrRenderAttr("aria-expanded", _ctx.$page.url.startsWith("/report"))} aria-controls="menureport"><i class="ri-file-copy-2-line"></i> <span>Laporan &amp; Statistik</span></a><div class="${ssrRenderClass([{ "show": _ctx.$page.url.startsWith("/report") }, "collapse menu-dropdown"])}" id="menureport"><ul class="nav nav-sm flex-column"><li class="nav-item">`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("report.index"),
        class: ["nav-link", { "active": _ctx.$page.url.startsWith("/report") }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Laporan Terkini Bencana `);
          } else {
            return [
              createTextVNode(" Laporan Terkini Bencana ")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li></ul></div></li><li class="nav-item"><a class="nav-link menu-link" href="#menuadmin" data-bs-toggle="collapse" role="button"${ssrRenderAttr("aria-expanded", _ctx.$page.url.startsWith("/admin"))} aria-controls="menuadmin"><i class="ri-admin-line"></i> <span>Administrator</span></a><div class="${ssrRenderClass([{ "show": _ctx.$page.url.startsWith("/admin") }, "collapse menu-dropdown"])}" id="menuadmin"><ul class="nav nav-sm flex-column"><li class="nav-item">`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`</li></ul></div></li><li class="nav-item"><a class="nav-link menu-link" href="#menusetting" data-bs-toggle="collapse" role="button"${ssrRenderAttr("aria-expanded", _ctx.$page.url.startsWith("/setting"))} aria-controls="menusetting"><i class="ri-settings-5-line"></i> <span>Settings</span></a><div class="${ssrRenderClass([{ "show": _ctx.$page.url.startsWith("/setting") }, "collapse menu-dropdown"])}" id="menusetting"><ul class="nav nav-sm flex-column"><li class="nav-item">`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("setting.state.index"),
        class: ["nav-link", { "active": _ctx.$page.url.startsWith("/setting/state") }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Negeri `);
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        class: ["nav-link", { "active": _ctx.$page.url.startsWith("/setting/district") }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Daerah `);
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        class: ["nav-link", { "active": _ctx.$page.url.startsWith("/setting/parish") }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Mukim `);
      ...
      _push(`</li></ul></div></li></ul></div></div><div class="sidebar-background"></div></div><div class="vertical-overlay"></div><div class="main-content"><div class="page-content"><div class="container-fluid">`);
