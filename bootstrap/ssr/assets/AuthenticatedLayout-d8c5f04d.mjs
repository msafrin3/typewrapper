...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li>`);
      if (_ctx.$page.props.auth.user.can.includes("view-bencana")) {
      ...
      if (_ctx.$page.props.auth.user.can.includes("view-pps")) {
        _push(`<li class="nav-item">`);
        _push(ssrRenderComponent(unref(Link), {
      ...
      if (_ctx.$page.props.auth.user.can.includes("view-laporan")) {
        _push(`<li class="nav-item"><a class="nav-link menu-link" href="#menureport" data-bs-toggle="collapse" role="button"${ssrRenderAttr("aria-expanded", _ctx.$page.url.startsWith("/report"))} aria-controls="menureport"><i class="ri-file-copy-2-line"></i> <span>Laporan &amp; Statistik</span></a><div class="${ssrRenderClass([{ "show": _ctx.$page.url.startsWith("/report") }, "collapse menu-dropdown"])}" id="menureport"><ul class="nav nav-sm flex-column">`);
        if (_ctx.$page.props.auth.user.can.includes("view-laporan-terkini")) {
          _push(`<li class="nav-item">`);
          _push(ssrRenderComponent(unref(Link), {
      ...
      if (_ctx.$page.props.auth.user.roles.includes("superadmin")) {
        _push(`<li class="nav-item"><a class="nav-link menu-link" href="#menusetting" data-bs-toggle="collapse" role="button"${ssrRenderAttr("aria-expanded", _ctx.$page.url.startsWith("/setting"))} aria-controls="menusetting"><i class="ri-settings-5-line"></i> <span>Settings</span></a><div class="${ssrRenderClass([{ "show": _ctx.$page.url.startsWith("/setting") }, "collapse menu-dropdown"])}" id="menusetting"><ul class="nav nav-sm flex-column"><li class="nav-item">`);
        _push(ssrRenderComponent(unref(Link), {
