...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Edit Meta Data" }, null, _parent));
                ...
                createVNode("div", { class: "col-md-4" }, [
                  createVNode("div", { class: "card" }, [
                    createVNode("div", { class: "card-header" }, [
                      createVNode("h3", { class: "card-title mb-0" }, "Edit Meta Data")
                    ]),
                    createVNode("form", {
                      ...
                      createVNode("div", { class: "card-body" }, [
                        createVNode("div", { class: "form-group mb-3" }, [
                          ...
                          withDirectives(createVNode("select", {
                            class: "form-control",
                            "onUpdate:modelValue": ($event) => unref(e_metadata).meta_id = $event
                          }, [
                            ...
                            [vModelSelect, unref(e_metadata).meta_id]
                          ]),
                        ...
                        createVNode("div", { class: "form-group mb-3" }, [
                          ...
                          withDirectives(createVNode("input", {
                            ...
                            "onUpdate:modelValue": ($event) => unref(e_metadata).name = $event
                          }, null, 8, ["onUpdate:modelValue"]), [
                            [vModelText, unref(e_metadata).name]
                          ]),
                        ...
                        createVNode("div", { class: "form-group mb-3" }, [
                          ...
                          withDirectives(createVNode("input", {
                            ...
                            "onUpdate:modelValue": ($event) => unref(e_metadata).group_helper = $event
                          }, null, 8, ["onUpdate:modelValue"]), [
                            [vModelText, unref(e_metadata).group_helper]
                          ])
                        ])
                      ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/MetaData/Edit.vue");
