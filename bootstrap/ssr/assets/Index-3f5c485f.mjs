import { getCurrentInstance, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createTextVNode, createCommentVNode, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (_ctx.$page.props.auth.user.can.includes("create-laporan-terkini")) {
              _push2(`<div class="mb-3"${_scopeId}><button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalGenerate"${_scopeId}><i class="ri-add-circle-fill align-bottom me-1"${_scopeId}></i> Jana Laporan </button></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="card"${_scopeId}><div class="card-header"${_scopeId}><h3 class="card-title mb-0"${_scopeId}>Senarai Laporan Terkini Kejadian Bencana</h3></div><div class="card-body"${_scopeId}>`);
                        ...
                        return openBlock(), createBlock("tr", null, [
                          ...
                          createVNode("td", null, [
                            createVNode("div", { class: "d-flex gap-2" }, [
                              ...
                              _ctx.$page.props.auth.user.can.includes("delete-laporan-terkini") ? (openBlock(), createBlock("button", {
                                key: 0,
                                type: "button",
            ...
            return [
              ...
              _ctx.$page.props.auth.user.can.includes("create-laporan-terkini") ? (openBlock(), createBlock("div", {
                key: 0,
                class: "mb-3"
              }, [
                createVNode("button", {
